...
/* ============ 送客サービス ============
   一括査定6件は実在サービス。facts は各公式サイトの公表情報（FACTS_ASOF 時点）に基づく。
   現時点では未提携のため affiliateUrl は空・officialUrl へ通常リンク（収益なしを明記）。
   ASP提携後は affiliateUrl と isPR:true を設定すれば PR表記+sponsored に自動で切り替わる。 */
const FACTS_ASOF = "2026-08-01";
const SERVICES = [
  { slug: "sumai-value", kind: "assessment", ranking: 1, name: "すまいValue",
    company: "大手不動産流通6社（三井不動産リアルティ・住友不動産ステップ・東急リバブル・野村不動産ソリューションズ・三菱地所ハウスネット・小田急不動産）の共同運営",
    officialUrl: "https://sumai-value.jp/", partnerLabel: "大手6社・792店舗（2026年4月時点・公式公表）",
    desc: "不動産流通大手6社が共同運営する一括査定サイト。査定依頼は大手6社のみに届く仕組みで、公式サイトでは全国792店舗（2026年4月時点）と公表されています。",
    merits: "大手6社に直接まとめて依頼できる／店舗網が広く都市部の実績が厚いとされる",
    demerits: "依頼先は運営6社に限られる／地方は対応店舗が少ないエリアもある",
    target: "大手に任せたい方・都市部の物件を売却する方",
    types: ["mansion", "house", "land"], reasons: ["sell", "relocation"] },
  { slug: "lifull-satei", kind: "assessment", ranking: 2, name: "LIFULL HOME'S 売却査定",
    company: "株式会社LIFULL", officialUrl: "https://www.homes.co.jp/satei/",
    partnerLabel: "参加5,145社（公式公表）",
    desc: "住宅情報サイトLIFULL HOME'Sの売却査定。公式サイトでは全国5,145社参加と公表され、メールアドレスのみで概算を確認できる匿名査定にも対応しています。",
    merits: "参加会社数が多い／匿名査定で概算だけ先に見られる／机上・訪問査定を選べる",
    demerits: "会社数が多いぶん依頼先の見極めは自分で行う必要がある",
    target: "まず匿名で相場感を知りたい方・幅広い会社から選びたい方",
    types: ["mansion", "house", "land"], reasons: ["sell", "relocation", "divorce"] },
  { slug: "ieul", kind: "assessment", ranking: 3, name: "イエウール",
    company: "株式会社Speee", officialUrl: "https://ieul.jp/",
    partnerLabel: "提携2,000社以上・最大6社同時依頼（公式公表）",
    desc: "公式サイトで提携2,000社以上・年間20万件以上の売却成立サポート実績と公表される一括査定サイト。最大6社へ同時に依頼できます。",
    merits: "地方を含むエリアカバーが広いとされる／最大6社を比較できる／クレームの多い会社は解除する方針を明示",
    demerits: "依頼後は複数社から連絡が来ることを想定しておく必要がある",
    target: "地方・郊外の物件の方・多くの会社から比較したい方",
    types: ["mansion", "house", "land"], reasons: ["sell", "inheritance", "vacant"] },
  { slug: "suumo-baikyaku", kind: "assessment", ranking: 4, name: "SUUMO売却査定",
    company: "株式会社リクルート", officialUrl: "https://suumo.jp/baikyaku/",
    partnerLabel: "参加社数は非公表（独自の掲載基準を明示）",
    desc: "リクルートが運営するSUUMOの売却査定。公式サイトでは利用者満足度91%、独自の掲載基準に沿った不動産会社のみ掲載と説明されています。",
    merits: "知名度の高いSUUMOブランド／大手から地域密着まで掲載／60秒入力",
    demerits: "参加会社数は公表されていない",
    target: "SUUMOの情報量と併せて売却を進めたい方",
    types: ["mansion", "house", "land"], reasons: ["sell", "relocation"] },
  { slug: "home4u", kind: "assessment", ranking: 5, name: "HOME4U",
    company: "NTT DATA WITH株式会社（NTTデータグループ）", officialUrl: "https://www.home4u.jp/",
    partnerLabel: "提携社数は時期により変動（公式サイト参照）",
    desc: "NTTデータグループが運営する老舗の不動産一括査定サイト。プライバシーマーク取得・SSL暗号化など情報管理体制を公式に明示しています。",
    merits: "NTTデータグループ運営の安心感／長年の運営実績／情報管理体制を明示",
    demerits: "最新の提携社数は公式サイトでの確認が必要",
    target: "個人情報の扱いを重視する方・運営母体の信頼性で選びたい方",
    types: ["mansion", "house", "land"], reasons: ["sell", "inheritance"] },
  { slug: "lvnmatch", kind: "assessment", ranking: 6, name: "リビンマッチ",
    company: "リビン・テクノロジーズ株式会社（東証グロース上場）", officialUrl: "https://www.lvnmatch.jp/",
    partnerLabel: "全国約2,100社以上・年間24万件の依頼実績（公式公表）",
    desc: "公式サイトで全国約2,100社以上参加・年間24万件の査定依頼実績と公表される一括査定サイト。売却以外に買取・リースバック等の比較サービスも展開しています。",
    merits: "査定以外（買取・土地活用等）の比較も同グループで揃う／最短45秒入力",
    demerits: "同時依頼数などの条件は公式サイトでの確認が必要",
    target: "売却と併せて買取・活用も比較したい方",
    types: ["mansion", "house", "land"], reasons: ["sell", "vacant", "inheritance"] },
  { slug: "demo-purchase-a", kind: "purchase", ranking: 7, name: "（デモ）ダイレクト買取窓口",
  ...
  { slug: "demo-leaseback-a", kind: "leaseback", ranking: 8, name: "（デモ）あんしんリースバック",
  ...
  { slug: "demo-landuse-a", kind: "landuse", ranking: 9, name: "（デモ）土地活用プラン一括請求",
  ...
  { slug: "demo-ninbai-a", kind: "purchase", ranking: 10, name: "（デモ）任意売却相談窓口",
...
const FAQS = [
  ...
  { q: "掲載されている査定サービスは実在のものですか？", a: "一括査定の比較は実在のサービスを掲載しており、提携社数などは各公式サイトの公表情報（時点併記）に基づきます。現在、当サイトは各サービスと提携しておらず、リンクから収益を得ていません。買取・リースバック・土地活用の一部枠は「デモ」表示です。" },
...
const DATA = {
  ...
  services: SERVICES.map(s => ({
    id: "sv_" + s.slug.replace(/-/g, "_"), slug: s.slug, kind: s.kind,
    isDemo: !s.officialUrl,                       // 実在サービスは officialUrl を持つ
    officialUrl: s.officialUrl || "", company: s.company || null,
    partnerLabel: s.partnerLabel || null, factsAsOf: s.officialUrl ? FACTS_ASOF : null,
    affiliateUrl: "", trackingCode: "", partnerCount: null, rating: null, ranking: s.ranking,
